				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"trigger_type": {
							...
							Deprecated:   "The field `trigger_type` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"threshold": {
							Type:       schema.TypeFloat,
							Optional:   true,
							Deprecated: "The field `threshold` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"threshold_type": {
							Type:         schema.TypeString,
							Optional:     true,
							ValidateFunc: validation.StringInSlice([]string{"LessThan", "LessThanOrEqual", "GreaterThan", "GreaterThanOrEqual"}, false),
							Deprecated:   "The field `threshold_type` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"time_range": {
							Type:         schema.TypeString,
							Optional:     true,
							...
							Deprecated:   "The field `time_range` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"trigger_source": {
							Type:         schema.TypeString,
							Optional:     true,
							ValidateFunc: validation.StringInSlice([]string{"AllTimeSeries", "AnyTimeSeries", "AllResults"}, false),
							Deprecated:   "The field `trigger_source` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"occurrence_type": {
							Type:         schema.TypeString,
							Optional:     true,
							ValidateFunc: validation.StringInSlice([]string{"AtLeastOnce", "Always", "ResultCount", "MissingData"}, false),
							Deprecated:   "The field `occurrence_type` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
						"detection_method": {
							Type:         schema.TypeString,
							Optional:     true,
							...
							Deprecated:   "The field `detection_method` is deprecated and will be removed in a future release of the provider. Please use one of the condition blocks, such as `static_condition` or `logs_static_condition` etc. to write triggers.",
						},
					},
				},
			},
